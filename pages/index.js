        ...
        <section id="about" className="section about-section">
          <div className="container">
            ...
            <div className="about-content">
              ...
              <div className="about-item">
                <p className="about-text">
                  I hold a BS from Worcester Polytechnic Institute (WPI), an MBA from Cambridge College, and specialized graduate studies from the Copenhagen Business School (CBS) and WU (Vienna University of Economics and Business).
                </p>
              </div>
