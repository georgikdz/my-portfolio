  ...
  const featuredProjects = [
    {
      ...
      metrics: "Identified and mitigated vulnerabilities in Meta's Llama language models for improved AI safety",
    ...
    },
    {
      ...
      description:
        "Led 5 product launches at Mitrend (Boston-based tech startup), managing cross-continental engineering and design teams. Conducted 20+ UX studies and achieved 20% increase in product-market fit.",
    ...
    },
    {
      ...
      description:
        "Led comprehensive AI adoption initiative at Advance Valuations, identifying 20+ automation opportunities and training 50+ employees. Designed and implemented AI solutions that automated routine tasks across core business functions.",
      tech: [
        "AI Strategy",
        "Process Automation",
        "Change Management",
  ...
  const earlierCareerProjects = [
    {
      ...
      description:
        "Architected comprehensive market expansion for KTM Motorcycles through EU driving school partnerships. Designed license fee reimbursement program with membership benefits, supported by scenario modeling and market analysis.",
      tech: [
        "Strategic Planning",
      ...
      metrics:
        "€62M projected growth | EU-wide partnership model | License reimbursement program",
    ...
    },
    {
      ...
      description:
        "Led ITSM adoption at Biogen's Boston HQ, supporting 200+ IT employees. Reduced escalations 40% through training programs and knowledge base infrastructure.",
          ...
          {featuredProjects.map((project, index) => (
            <div key={index} className="project-card">
              ...
              >
                ...
                <span
                  style={{ fontSize: '0.8rem', color: '#718096', fontWeight: '500' }}
                >
                  {project.period}
                </span>
              </div>
              ...
              <div className="project-links">
                <a
                  href="https://www.linkedin.com/in/georgikdz/"
                  className="btn"
                  target="_blank"
